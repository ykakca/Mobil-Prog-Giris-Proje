...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    try {
                        //Picasso.get(EditProfileActivity.this).load(image).into(set);
                    } catch (Exception e) {
                    }
                }
            }
        ...
        editpassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                pd.setMessage("Şifre Değiştiriliyor");
        ...
        editname.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pd.setMessage("İsim Güncelleniyor");
    ...
    private void showPasswordChangeDailog() {
        View view = LayoutInflater.from(this).inflate(R.layout.update_password_dialog, null);
        ...
        editpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(oldp)) {
                    Toast.makeText(EditProfileActivity.this, "Şifre boş olamaz", Toast.LENGTH_LONG).show();
                    return;
                }
                    ...
                    public void onSuccess(Void aVoid) {
                        user.updatePassword(newp)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        pd.dismiss();
                                        Toast.makeText(EditProfileActivity.this, "Şifre Değiştirildi", Toast.LENGTH_LONG).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        pd.dismiss();
                                        Toast.makeText(EditProfileActivity.this, "Başarısız", Toast.LENGTH_LONG).show();
                                    }
                                });
                    }
                }).addOnFailureListener(new OnFailureListener() {
                ...
                if (!TextUtils.isEmpty(value)) {
                    ...
                    databaseReference.child(firebaseUser.getUid()).updateChildren(result).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(EditProfileActivity.this, " Güncellendi ", Toast.LENGTH_LONG).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            pd.dismiss();
                            Toast.makeText(EditProfileActivity.this, "Güncellenemedi", Toast.LENGTH_LONG).show();
                        }
                    });
                    if (key.equals("name")) {
            ...
            case CAMERA_REQUEST: {
                if (grantResults.length > 0) {
                    ...
                    if (camera_accepted && writeStorageaccepted) {
                        ...
                        Toast.makeText(this, "Kamera erişim izni gerekli", Toast.LENGTH_LONG).show();
                    }
                }
            }
            break;
            case STORAGE_REQUEST: {
                if (grantResults.length > 0) {
                    ...
                    if (writeStorageaccepted) {
                        ...
                        Toast.makeText(this, "Depolama erişim izni gerekli", Toast.LENGTH_LONG).show();
                    }
                }
            }
            break;
