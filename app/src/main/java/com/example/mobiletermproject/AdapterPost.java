...
public class AdapterPost extends RecyclerView.Adapter<AdapterPost.MyHolder> {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_posts_profiles, parent, false);
            ...
            public void onSuccess(Void aVoid) {
                ...
                query.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        pd.dismiss();
                        Toast.makeText(context, "Başarıyla Silindi", Toast.LENGTH_LONG).show();
                    }
        ...
        liekeref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(pid).hasChild(myuid)) {
                    ...
                    holder.likebtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.baseline_thumb_up_off_alt_24, 0, 0, 0);
