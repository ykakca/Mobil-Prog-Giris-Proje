        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(titl)) {
                    ...
                    Toast.makeText(getContext(), "Başlık boş olamaz", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (TextUtils.isEmpty(description)) {
                    ...
                    Toast.makeText(getContext(), "Açıklama boş olamaz", Toast.LENGTH_LONG).show();
                    return;
                }

                // If empty show error
                if (imageuri == null) {
                    Toast.makeText(getContext(), "Görsel seçiniz", Toast.LENGTH_LONG).show();
                    return;
                } else {
            ...
            case CAMERA_REQUEST: {
                if (grantResults.length > 0) {
                    ...
                    if (camera_accepted && writeStorageaccepted) {
                        ...
                        Toast.makeText(getContext(), "Kamera erişim izni gerekli", Toast.LENGTH_LONG).show();
                    }
                }
            }
            ...
            case STORAGE_REQUEST: {
                if (grantResults.length > 0) {
                    ...
                    if (writeStorageaccepted) {
                        ...
                        Toast.makeText(getContext(), "Depolama erişim izni gerekli", Toast.LENGTH_LONG).show();
                    }
                }
            }
            break;
